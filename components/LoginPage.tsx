  ...
  return (
    <div className="min-h-screen bg-dark-bg flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md animate-in fade-in slide-in-from-bottom-8 duration-700 relative z-10">
        ...
        <div className="glass-card inner-glow bg-dark-card/60 backdrop-blur-3xl border border-white/5 rounded-[3rem] p-8 lg:p-10 shadow-[0_40px_100px_rgba(0,0,0,0.8)]">
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                required
                className="w-full px-6 py-5 bg-dark-bg/60 border border-dark-border rounded-2xl focus:border-brand-500 outline-none text-white transition-all font-bold placeholder:text-gray-500"
              />
            </div>
            ...
            <div className="relative">
              ...
              <button 
                ...
                className="absolute right-6 bottom-5 text-gray-500 hover:text-gray-300 transition-colors"
              >
                {showPassword ? (
